...
static int *move_table_UD_edge_permutations       = NULL;
...
int *get_move_table_UD_edge_permutations() { return move_table_corner_permutations; }
...
void coord_apply_move(coord_cube_t *cube, move_t move) {
    ...
    assert(move_table_UD_edge_permutations != NULL);
    ...
    assert(cube->UD_edge_permutations * N_MOVES + move < N_EDGE8_PHASE1_PERMUTATIONS * N_MOVES);
    ...
    cube->UD_edge_permutations = move_table_UD_edge_permutations[cube->UD_edge_permutations * N_MOVES + move];
    ...
    assert(cube->UD_edge_permutations >= 0);
    ...
    assert(cube->UD_edge_permutations < N_EDGE8_PHASE1_PERMUTATIONS);
